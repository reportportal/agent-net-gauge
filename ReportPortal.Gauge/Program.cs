...
namespace ReportPortal.GaugePlugin
{
    class Program
    {
        ...
        public class MyHandler : Gauge.Messages.Reporter.ReporterBase
        {
            ...
            {
                return base.NotifyScenarioExecutionEnding(request, context);
            }
